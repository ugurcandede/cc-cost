...
// Header logo as the tab icon; a standalone SVG needs xmlns
const FAVICON = 'data:image/svg+xml,' + encodeURIComponent(ICON.logo.replace('<svg ', '<svg xmlns="http://www.w3.org/2000/svg" '));
